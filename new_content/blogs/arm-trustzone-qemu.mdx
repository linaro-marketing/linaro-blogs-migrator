...
![Arm-TrustZone-Logo class=small-inline](/linaro-website/images/blog/Arm-TrustZone-Logo)
...
![Qemu-logo class=small-inline](/linaro-website/images/blog/Qemu-logo)
...
![quem-trusted class=small-inline](/linaro-website/images/blog/quem-trusted)
...
QEMU has made advances in supporting some of the latest Arm architectural features such as 64-bit and Armv8-A, however, it still lacks support for the Arm Security Extensions. Attempts to utilize features such as the *smc* instruction or secure registers will result in an undefined operation failure.
...
![Qemu - timeline](/linaro-website/images/blog/quem-timeline)
...
\[3] [http://wiki.qemu.org/Main\_Page](http://wiki.qemu.org/Main_Page)
